				...
				<div className="breadcrumbs-inner">
					<div className="container">
						<div className="breadcrumbs-text">
							<Link to="#" className="cate wow animate__fadeInUp" data-wow-duration="0.3s">{courseName}</Link>
							<h1 className="breadcrumbs-title wow animate__fadeInUp" data-wow-duration="0.5s">{courseTitle}</h1>
							<ul className="user-section wow animate__fadeInUp" data-wow-duration="0.7s">
								<li className="user">
